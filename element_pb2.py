...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ELEMENT']._serialized_end=808
  _globals['_FEEDMESSAGE']._serialized_start=810
  _globals['_FEEDMESSAGE']._serialized_end=839
